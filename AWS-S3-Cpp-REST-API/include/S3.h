...
class S3
{
	...
	string getObject(const string & file, const string & bucket);
        bool putObject(const string & file, const string & bucket); // returns true, if file has been uploaded succesfully.
